...
export const site = {
  name: 'Fieldcraft Consulting',
  tagline: 'Practical strategy. Clear communication. Real-world delivery.',
  description:
    'Fieldcraft Consulting helps regional businesses, sporting bodies, community organisations and practical industries build clear plans, stronger communication and better delivery.',
  // Update these contact details to the real business details.
  email: 'hello@fieldcraftconsulting.com.au',
  phone: '0400 000 000',
...
export const whatWeDo: Service[] = [
  ...
  },
  {
    ...
    href: '/business-coaching/#business-audit',
  },
  {
    title: 'Business Turnaround',
    summary:
      'Hands-on intervention for businesses under serious pressure — stabilise, rebuild and drive recovery.',
...
export const supportLevels: CoachingTier[] = [
  ...
  },
  {
    id: 'business-audit',
    level: '2',
    title: 'Fieldcraft Business Audit',
