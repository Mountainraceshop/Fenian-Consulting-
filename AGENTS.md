...
This repo is the **Fenian Consulting** marketing website — a static [Astro](https://astro.build/) site (no backend/database). Standard commands and editing guidance live in `README.md`; only non-obvious notes are below.
